...
namespace HRM_ROHTO.Models
{
    ...
    public partial class HRM_ROHTOEntities : DbContext
    {
        ...
        public virtual ObjectResult<pr_CheckEmployeeHasRegisterMeal_Result> pr_CheckEmployeeHasRegisterMeal(Nullable<int> day, Nullable<int> month, Nullable<int> year, Nullable<int> employeeID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<pr_CheckEmployeeHasRegisterMeal_Result>("pr_CheckEmployeeHasRegisterMeal", dayParameter, monthParameter, yearParameter, employeeIDParameter);
        }
    
        public virtual int pr_DeleteAllData1()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("pr_DeleteAllData1");
        }
    
        public virtual ObjectResult<pr_ExportEmployeeList_Result> pr_ExportEmployeeList()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<pr_ExportEmployeeList_Result>("pr_ExportEmployeeList");
        }
    
        public virtual ObjectResult<pr_LoadChoosenMenu_Result> pr_LoadChoosenMenu(Nullable<int> day, Nullable<int> month, Nullable<int> year, Nullable<int> shiftID, Nullable<int> productTypeID)
        {
            var dayParameter = day.HasValue ?
                new ObjectParameter("day", day) :
                new ObjectParameter("day", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<pr_LoadChoosenMenu_Result>("pr_LoadChoosenMenu", dayParameter, monthParameter, yearParameter, shiftIDParameter, productTypeIDParameter);
        }
    
        public virtual ObjectResult<pr_LoadExceptionMeal_Result> pr_LoadExceptionMeal()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<pr_LoadExceptionMeal_Result>("pr_LoadExceptionMeal");
        }
    
        public virtual ObjectResult<pr_ReportMealCardByDay_Result> pr_ReportMealCardByDay(Nullable<int> day, Nullable<int> month, Nullable<int> year)
        {
            var dayParameter = day.HasValue ?
                new ObjectParameter("day", day) :
                new ObjectParameter("day", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<pr_ReportMealCardByDay_Result>("pr_ReportMealCardByDay", dayParameter, monthParameter, yearParameter);
        }
    
        public virtual int pr_ReportPrintMealToDay(Nullable<System.DateTime> date)
        {
            var dateParameter = date.HasValue ?
                new ObjectParameter("date", date) :
                new ObjectParameter("date", typeof(System.DateTime));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("pr_ReportPrintMealToDay", dateParameter);
        }
    
        public virtual ObjectResult<pr_ReportRegisterByEmployee_Result> pr_ReportRegisterByEmployee(Nullable<System.DateTime> fromdate, Nullable<System.DateTime> todate)
        {
            var fromdateParameter = fromdate.HasValue ?
                new ObjectParameter("fromdate", fromdate) :
                new ObjectParameter("fromdate", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<pr_ReportRegisterByEmployee_Result>("pr_ReportRegisterByEmployee", fromdateParameter, todateParameter);
        }
    
        public virtual ObjectResult<pr_ReportSLPhanComCanThanhToan_Result> pr_ReportSLPhanComCanThanhToan(Nullable<System.DateTime> fromdate, Nullable<System.DateTime> todate)
        {
            var fromdateParameter = fromdate.HasValue ?
                new ObjectParameter("fromdate", fromdate) :
                new ObjectParameter("fromdate", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<pr_ReportSLPhanComCanThanhToan_Result>("pr_ReportSLPhanComCanThanhToan", fromdateParameter, todateParameter);
        }
    
        public virtual ObjectResult<pr_ReportSLPhanComHangNgay_Result> pr_ReportSLPhanComHangNgay(Nullable<System.DateTime> fromdate, Nullable<System.DateTime> todate)
        {
            var fromdateParameter = fromdate.HasValue ?
                new ObjectParameter("fromdate", fromdate) :
                new ObjectParameter("fromdate", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<pr_ReportSLPhanComHangNgay_Result>("pr_ReportSLPhanComHangNgay", fromdateParameter, todateParameter);
        }
    
        public virtual int pr_ReportSLPhanComTheoNhanVien(Nullable<System.DateTime> fromdate, Nullable<System.DateTime> todate)
        {
            var fromdateParameter = fromdate.HasValue ?
                new ObjectParameter("fromdate", fromdate) :
                new ObjectParameter("fromdate", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("pr_ReportSLPhanComTheoNhanVien", fromdateParameter, todateParameter);
        }
    
        public virtual ObjectResult<pr_ReportSummaryByEmployee_Result> pr_ReportSummaryByEmployee(Nullable<System.DateTime> fromdate, Nullable<System.DateTime> todate)
        {
            var fromdateParameter = fromdate.HasValue ?
                new ObjectParameter("fromdate", fromdate) :
                new ObjectParameter("fromdate", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<pr_ReportSummaryByEmployee_Result>("pr_ReportSummaryByEmployee", fromdateParameter, todateParameter);
        }
    
        public virtual ObjectResult<pr_ReportSummaryByShift_Result> pr_ReportSummaryByShift(Nullable<System.DateTime> fromdate, Nullable<System.DateTime> todate)
        {
            var fromdateParameter = fromdate.HasValue ?
                new ObjectParameter("fromdate", fromdate) :
                new ObjectParameter("fromdate", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<pr_ReportSummaryByShift_Result>("pr_ReportSummaryByShift", fromdateParameter, todateParameter);
        }
    
        public virtual int pr_UpdateExceptionMealUsed(Nullable<int> shiftID)
        {
            var shiftIDParameter = shiftID.HasValue ?
                new ObjectParameter("shiftID", shiftID) :
                new ObjectParameter("shiftID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("pr_UpdateExceptionMealUsed", shiftIDParameter);
        }
    }
}
